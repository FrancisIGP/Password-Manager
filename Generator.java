...
public class Generator {
    ...
    public static void setup(String[] args) {
        ...
        char[] input1 = c.readPassword();
        String temp1 = String.valueOf(input1);

        System.out.print("\n Confirm password: ");
        char[] input2 = c.readPassword();
        String tempB = String.valueOf(input2);

        if (!temp1.equals(tempB)) {
            clearScreen();
            System.out.println("\n (\033[31mError\033[0m): Password did not match! Please retry.\n");
            setup(args);
        }
